!function() {
  ...
  d3.layout.tree = function() {
    ...
    var separation = defaultSeparation, size = [ 1, 1 ], nodeSize = null;
    var nodeSizeFixed = [ 1, 1 ];
    ...
    function getXSize(n) {
      var s;
      return nodeSizeFixed ? nodeSizeFixed[0] : typeof n.x_size != "undefined" ? n.x_size : (s = nodeSizeFunc(n), 
      n.y_size = s[1], n.x_size = s[0]);
    }
    function getYSize(n) {
      var s;
      return nodeSizeFixed ? nodeSizeFixed[1] : typeof n.y_size != "undefined" ? n.y_size : (s = nodeSizeFunc(n), 
      n.x_size = s[0], n.y_size = s[1]);
    }
    function tree(d, i) {
      var nodes = hierarchy.call(this, d, i);
      var root_ = nodes[0], root = wrapTree(root_);
      ...
      if (size) {
        var left = root_, right = root_, bottom = root_;
    ...
    function firstWalk(v) {
      var children = v.children, siblings = v.parent.children, left_sibling = v.i ? siblings[v.i - 1] : null;
      if (children.length) {
        d3_layout_treeShift(v);
        var cfirst = children[0], clast = children[children.length - 1];
        var midpoint = (cfirst.z - getXSize(cfirst._) / 2 + clast.z + getXSize(clast._) / 2) / 2;
        if (left_sibling) {
    ...
    function apportion(v, w, ancestor) {
      if (w) {
        ...
        var vip_changed, vop_changed, vim_changed, vom_changed;
        while (true) {
          vip_changed = false;
          vop_changed = false;
          vim_changed = false;
          ...
          var next_y = Math.min(vir_end_y, vor_end_y, vil_end_y, vol_end_y);
          if (next_y == vir_end_y) {
          ...
          if (vim_changed || vip_changed) {
            shift = vim.z + sim - vip.z - sip + separation(vim._, vip._, Math.max(vim._.depth - v_depth, vip._.depth - v_depth) + 1);
            if (shift > 0) {
